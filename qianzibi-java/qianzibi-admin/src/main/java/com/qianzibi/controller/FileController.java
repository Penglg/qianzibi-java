...
import com.qianzibi.entity.enums.ImageFileUploadTypeEnum;
import com.qianzibi.entity.enums.ImportTemplateTypeEnum;
import com.qianzibi.entity.enums.ScaleFilter;
...
public class FileController {
    ...
    public R uploadFile(MultipartFile file, Integer ImagType) {
        ...
        try {
            ...
            throw new BusinessException(ResultCode.ERROR_BAD, "文件上传失败");
        }
...
//        return R.ok().data(localFile); // 保存绝对路径
    ...
    public void downloadTemplate(HttpServletResponse response, HttpServletRequest request, Integer type) {
        ...
        if (templateTypeEnum == null) {
            throw new BusinessException(ResultCode.ERROR_600, "类型错误");
        }
