...
public class CommonUtils {
     ...
     * @throws BusinessException 如果参数为空，则抛出业务异常
     */
    public static void checkParam(Object param) {
        try {
            ...
            // 如果所有字段值都为空，则抛出业务异常
            if (!notEmpty) {
                throw new BusinessException(ResultCode.NOT_FOUND, "多参数更新，删除，必须有非空条件");
            }
            ...
            e.printStackTrace();
            // 抛出业务异常
            throw new BusinessException(ResultCode.NOT_FOUND, "校验参数是否为空失败");
        }
    }
